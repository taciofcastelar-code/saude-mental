...
export function renderAtendimentos(){
  return `<section class="card">
    ...
    <p>Os atendimentos são registrados no formulário padronizado e enviados automaticamente para a Planilha Mestre pelo Apps Script V5.5.</p>
  ...
  <section class="card">
    ...
    <p class="muted">Google Forms → Apps Script V5.5 → Planilha Mestre → Indicadores → Dashboard do aplicativo.</p>
  </section>`;
}
